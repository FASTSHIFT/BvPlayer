...
#else
  typedef volatile uint32_t PCD8544_PortReg;
  typedef uint8_t PCD8544_PortMask;
#endif
...
#define PCD8544_SPI_CLOCK_DIV 4//SPI_CLOCK_DIV4
...
class Adafruit_PCD8544 : public Adafruit_GFX {
 ...
 private:
  ...
  volatile PCD8544_PortReg  *mosiport, *clkport;
  PCD8544_PortMask mosipinmask, clkpinmask;
