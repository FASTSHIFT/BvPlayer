...
DRESULT Adafruit_SPIFlash_FatFs::diskRead(unsigned char *buff, DWORD sector,
                                          UINT count) {
...
DRESULT Adafruit_SPIFlash_FatFs::diskWrite(const unsigned char *buff, DWORD sector,
                                           UINT count) {
...
DRESULT Adafruit_SPIFlash_FatFs::diskIoctl(unsigned char cmd, void* buff) {
...
DRESULT Adafruit_M0_Express_CircuitPython::diskRead(unsigned char *buff, DWORD sector,
                                                    UINT count) {
...
DRESULT Adafruit_M0_Express_CircuitPython::diskWrite(const unsigned char *buff,
