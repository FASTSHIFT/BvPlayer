...
public:
  ...
  virtual DRESULT diskRead(unsigned char *buff, DWORD sector, UINT count);
  virtual DRESULT diskWrite(const unsigned char *buff, DWORD sector, UINT count);
  virtual DRESULT diskIoctl(unsigned char cmd, void* buff);
